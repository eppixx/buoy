...
#[relm4::factory(pub)]
impl relm4::factory::FactoryComponent for ArtistElement {
        ...
        gtk::Box {
            ...
            gtk::Overlay {
                add_overlay = &gtk::Box {
                    ...
                    append: favorite = &self.favorite.clone() -> gtk::Button {
                        add_css_class: "cover-favorite",
                        set_width_request: 24,
                        set_height_request: 24,
                        set_icon_name: "non-starred-symbolic",

                        connect_clicked => ArtistElementIn::FavoriteToggle,
                    }
                },
                ...
                set_child = &gtk::Button {
                    ...
                    connect_clicked => ArtistElementIn::Clicked,
    ...
    fn update_with_view(
        ...
        match msg {
            ...
            ArtistElementIn::FavoriteToggle => match widgets.favorite.icon_name().as_deref() {
                Some("starred-symbolic") => {
                    sender
                        .output(ArtistElementOut::FavoriteClicked(
                            self.init.id.clone(),
                            false,
                        ))
                        .unwrap();
            ...
            ArtistElementIn::Clicked => sender
                .output(ArtistElementOut::Clicked(self.init.clone()))
                .unwrap(),
