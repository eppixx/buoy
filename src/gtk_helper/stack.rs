...
pub trait StackExt {
    fn add_enumed<T: Display + TryFrom<String>>(&self, child:  &impl glib::object::IsA<gtk::Widget>, state: T) -> gtk::StackPage;
...
impl StackExt for gtk::Stack {
    fn add_enumed<T: Display>(&self, child: &impl glib::object::IsA<gtk::Widget>, state: T) -> gtk::StackPage {
